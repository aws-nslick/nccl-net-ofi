...
#include "nccl_ofi_msgbuff.hpp"
#include "nccl_ofi_topo.hpp"
#include "nccl_ofi_deque.hpp"
...
static_assert(sizeof(nccl_net_ofi_rdma_ctrl_msg_t) == 56,
...
/* Since this is a message on the wire, check that it has the expected size */
static_assert(sizeof(nccl_ofi_rdma_connection_info_t) == 236,
